...
CREATE TABLE IF NOT EXISTS core_schema.organization_nodes (
  ...
  category varchar(32) NOT NULL DEFAULT 'unit' CHECK (category IN ('unit', 'position')),
  node_type_id uuid REFERENCES core_schema.organization_node_types(id) ON DELETE SET NULL,
