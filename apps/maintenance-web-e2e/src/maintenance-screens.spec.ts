...
const workspace={tenantId:'33333333-3333-4333-8333-333333333333',actor:{id:'b3333333-3333-4333-8333-333333333333',name:'Admin Minh Long'},permissions:{canManageAssets:true,canManageJobPlans:true,canManageSchedules:true},assets,jobPlans:[jobPlan],schedules:[schedule],occurrences:[occurrence],procedureCatalog:[{definitionId:schedule.procedureDefinitionId,code:'EXEC_QT_MSTB',name:schedule.procedureDefinitionName,versionNumber:1,status:'published',synchronizedAt:now}],metrics:{activeSchedules:1,upcomingOccurrences:0,generatedOccurrences:1,completedOccurrences:0}};
