...
const definition = {
  id: '41000000-0000-4000-8000-000000000001', code: 'QT_MSTB', name: 'Quy trình Mua sắm Vật tư thiết bị', description: 'Từ đề nghị mua sắm đến phê duyệt và đặt hàng.', kind: 'process', status: 'published', versionNumber: 1, createdAt: now, updatedAt: now, publishedAt: now, steps: [
